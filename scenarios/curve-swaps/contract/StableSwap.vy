...
PRECISION_MUL: constant(uint256[N_COINS]) = [1, 1, 1]  # spamoor: all mock coins are 18-decimals
RATES: constant(uint256[N_COINS]) = [1000000000000000000, 1000000000000000000, 1000000000000000000]  # spamoor: all mock coins are 18-decimals

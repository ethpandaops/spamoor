...
var ScenarioDescriptor = scenariotypes.ScenarioDescriptor{
	Name:           ScenarioName,
	Description:    "Send self EOA 0ETH transactions with different configurations",
...
func (s *Scenario) sendTx(ctx context.Context, txIdx uint64, onComplete func()) (*types.Transaction, *txbuilder.Client, *txbuilder.Wallet, error) {
	...
	toAddr := s.walletPool.GetWallet(spamoor.SelectWalletByIndex, int(txIdx)).GetAddress()

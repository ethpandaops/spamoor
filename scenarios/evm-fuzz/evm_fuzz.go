...
func (s *Scenario) Flags(flags *pflag.FlagSet) error {
	...
	flags.StringVar(&s.options.FuzzMode, "fuzz-mode", ScenarioDefaultOptions.FuzzMode, "Fuzzing mode: 'all' (opcodes+precompiles), 'opcodes' (EVM opcodes only), 'precompiles' (precompiles only), 'state-access' (storage/access gas accounting)")
...
func (s *Scenario) validateFuzzMode(mode string) error {
	validModes := []string{"all", "opcodes", "precompiles", "state-access"}

...
func StartHttpServer(config *types.FrontendConfig, daemon *daemon.Daemon) {
	...
	apiRouter.HandleFunc("/spammer/{id}/effective-config", apiHandler.GetEffectiveConfig).Methods("GET")
	apiRouter.HandleFunc("/spammer/{id}/group", apiHandler.SetSpammerGroup).Methods("PUT")
	apiRouter.HandleFunc("/spammer/{id}/group", apiHandler.RemoveSpammerGroup).Methods("DELETE")
	apiRouter.HandleFunc("/spammer-group", apiHandler.CreateSpammerGroup).Methods("POST")
	apiRouter.HandleFunc("/spammer-group/{id}", apiHandler.UpdateSpammerGroup).Methods("PUT")
	apiRouter.HandleFunc("/spammer-group/{id}/members/order", apiHandler.ReorderGroupMembers).Methods("PUT")

...
-- Default spammers are no longer inserted via schema migrations. They are imported
-- from the embedded YAML files in daemon/default-spammers/ on first launch.

...
func main() {
	...
	flags.Uint64Var(&cliArgs.fundingGasLimit, "funding-gas-limit", 200000, "Gas limit for wallet funding transactions (200000 default for EIP-8037 state creation gas).")
